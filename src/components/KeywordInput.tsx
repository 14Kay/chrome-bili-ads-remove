			...
			<form onSubmit={handleSubmit} className="flex items-stretch gap-2 transition-all">
				<div className="relative flex-1 group">
					<input
						...
						className="w-full pl-3 pr-2.5 py-1.5 text-xs bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md outline-none transition-all placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:border-bili-pink focus:ring-1 focus:ring-bili-pink dark:focus:border-bili-pink hover:border-gray-300 dark:hover:border-gray-600 disabled:opacity-60 disabled:cursor-not-allowed text-gray-800 dark:text-gray-200"
					/>
				</div>
			...
			{feedback &&
				createPortal(
					<div className="fixed bottom-12 left-1/2 -translate-x-1/2 z-[9999] animate-slide-up pointer-events-none w-max max-w-[90%]">
						<div
							className={`flex items-center gap-2 px-3 py-2 rounded-full shadow-xl backdrop-blur-md border transition-all ${
